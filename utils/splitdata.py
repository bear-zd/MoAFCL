...
class strategy():
    ...
    '''
    def __init__(self, domains:List[str], num_client:int, num_sample_per:int) -> None:
...
def splitdata(indir:str,outdir:str, sample_strategy:strategy=None) :
    '''
...
if __name__ == "__main__":
    INDIR = "officehome"
    OUTDIR = 'splitdata'
    sample_strategy = uniform_strategy(os.listdir(INDIR), 10, 1000)
    splitdata(INDIR, OUTDIR, sample_strategy)
